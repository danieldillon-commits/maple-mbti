  ...
  ENFP: [
    {
      ...
      answers: [
        ...
        { text: "고수들의 플레이 영상을 찾아본다.", job: "카데나" }
      ]
    },
    {
      ...
      answers: [
        ...
        { text: "어려운 직업에 도전해보고 싶어서", job: "카데나" }
      ]
    },
    {
...
const resultDescriptions = {
  ...
  "다크나이트":
    "당신은 쉽게 포기하지 않는 사람입니다. 남들이 지칠 때도 묵묵히 자신의 길을 걸어갑니다. 결국 끝까지 버티는 사람이 가장 멀리 간다는 것을 믿습니다.",

  "카인":
    "당신은 화려하게 드러나기보다 자신만의 분위기로 사람을 끌어당기는 사람입니다. 남들의 시선보다 스스로의 기준과 감성을 더 중요하게 생각합니다.",
  ...
  "카이저":
    "당신은 성장형 주인공에 가깝습니다. 지금의 모습보다 앞으로의 가능성에 더 큰 가치를 둡니다. 꾸준한 성장 끝에 강해질 수 있다고 믿습니다.",
